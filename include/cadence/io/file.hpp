...
*/
/*******************************************************************************
 * libcadence: Unix File handle wrapper
 *	@file		cadence/io/file.hpp
 ******************************************************************************/
#pragma once
#ifndef CADENCE_IO_FILE_HPP
#define CADENCE_IO_FILE_HPP
...
public:
     ...
     * @see File::read()
     */
    IOResult read(Solace::MutableMemoryView& buffer) override;
     ...
     */
    IOResult write(Solace::MemoryView const& buffer) override;
...
protected:
     ...
     */
    File(Solace::Path const& path, int flags = 0);
