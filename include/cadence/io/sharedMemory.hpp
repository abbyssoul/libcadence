...
*/
/*******************************************************************************
 * libcadence: Unix POSIX shared memory object
 *	@file		cadence/io/sharedMemory.hpp
 ******************************************************************************/
#pragma once
#ifndef CADENCE_IO_SHAREDMEMORY_HPP
#define CADENCE_IO_SHAREDMEMORY_HPP

#include "cadence/io/selectable.hpp"
#include "cadence/io/file.hpp"           // File::Mode
...
public:
    ...
    using size_type = Solace::MutableMemoryView::size_type;
...
public:
     ...
     */
    static SharedMemory create(Solace::Path&& pathname, size_type size,
     ...
     */
    static Solace::MemoryResource createAnon(size_type size,
     ...
     * FIXME(abbyssoul): should return Result<SharedMemory, IOError>
     */
    static SharedMemory open(Solace::Path const& pathname, File::AccessMode mode = File::AccessMode::ReadWrite);
     ...
     */
    static void unlink(Solace::Path const& pathname);
     ...
     */
    static Solace::MemoryResource mapMem(int fd, size_type memSize,
                                Access mapping = Access::Private,
                                int protection = Protection::Read | Protection::Write);
...
public:
     ...
     */
    Solace::MemoryResource map(Access mapping = Access::Private,
...
protected:
     ...
     */
    SharedMemory(poll_id fd, Solace::Path&& path) noexcept;
...
#endif  // CADENCE_IO_SHAREDMEMORY_HPP
