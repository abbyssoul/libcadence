...
/*******************************************************************************
 * libcadence: IOObject
 *	@file		cadence/ioobject.hpp
 *	@brief		Interface for IO objects
 ******************************************************************************/
#pragma once
#ifndef CADENCE_IOOBJECT_HPP
#define CADENCE_IOOBJECT_HPP
...
public:
    ...
    using IOResult = Solace::Result<size_type, Solace::Error>;
...
public:
     ...
     */
    IOResult read(Solace::ByteWriter& destBuffer) {
     ...
     * @return Number of bytes actually read.
     */
    IOResult read(Solace::ByteWriter& destBuffer, size_type bytesToRead);
     ...
     */
    virtual IOResult read(Solace::MutableMemoryView& destBuffer) = 0;
     ...
     */
    IOResult write(Solace::ByteReader& srcBuffer) {
     ...
     * @return Number of bytes actually writen
     */
    IOResult write(Solace::ByteReader& srcBuffer, size_type bytesToWrite);
     ...
     * @return Number of bytes actually writen
     */
    virtual IOResult write(Solace::MemoryView const& srcBuffer) = 0;

};

}  // End of namespace cadence
#endif  // CADENCE_IOOBJECT_HPP
